...
As wedges are registered, they added to a list in order of registration. When
...
To complement Wedge and it's built-in Gem Wedge, you can install the +gem-wedge+
gem.

  $ gem install gem-wedge

This turn the Gem Wedge into a gem plug-in, so it will be automatically loaded
whenever RubyGems is loaded. See the the +gem-wedge+ README[http://github.com/rubyworks/gem-wedge]
file for more information about the Gem Wedge and why it is so useful.
