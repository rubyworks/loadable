...
{Website}[http://github.com/rubyworks/wedge] |
{Development}[http://github.com/rubyworks/wedge] |
...
Load::Wedge.new is actually just a helper method. One could write a load wedge without
